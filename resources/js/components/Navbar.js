...
function Navbar() {
  return (
    <div className="flex flex-row h-1/10 bg-teal-500 sticky top-0">
        ...
        <button className="relative h-full w-full bg-green-500"><LinkRouter to="/app/profile/123"><UserCircleSolid/></LinkRouter></button>
